    ...
    <div className="space-y-12">
      <section className="text-center relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white rounded-lg">
          <h1 className="text-4xl font-bold mb-4">Welcome to Home Remedy Guru</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent className="flex items-center">
              <Image src="/placeholder.svg?height=100&width=100" alt="Safe and Gentle" width={100} height={100} className="mr-4" />
          ...
          <Card>
            ...
            <CardContent className="flex items-center">
              <Image src="/placeholder.svg?height=100&width=100" alt="Cost-Effective" width={100} height={100} className="mr-4" />
          ...
          <Card>
            ...
            <CardContent className="flex items-center">
              <Image src="/placeholder.svg?height=100&width=100" alt="Holistic Approach" width={100} height={100} className="mr-4" />
          ...
          <Card>
            ...
            <CardContent className="flex items-center">
              <Image src="/placeholder.svg?height=100&width=100" alt="Empowering Self-Care" width={100} height={100} className="mr-4" />
